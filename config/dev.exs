...
config :baddl, Baddl.Repo,
  database: Path.expand("../baddl_dev.db", Path.dirname(__ENV__.file)),
  pool_size: 5,
  stacktrace: true,
...
config :baddl, BaddlWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "+tdEBYyAGVCodoZZfircakKoXq02m4t0fWFvGIJ7htxYeCAdUe1navZbGy3qp1YD",
  watchers: [
...
config :baddl, BaddlWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/baddl_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :baddl, dev_routes: true
